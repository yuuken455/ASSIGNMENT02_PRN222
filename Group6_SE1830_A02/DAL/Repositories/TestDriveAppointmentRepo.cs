...
namespace DAL.Repository
{
    public class TestDriveAppointmentRepo : ITestDriveAppointmentRepo
    {
        ...
        public TestDriveAppointmentRepo(DBContext context) { _context = context; }
        ...
        public async Task<ICollection<TestDriveAppointment>> GetAllAppointments()
        {
            return await _context.TestDriveAppointments
                ...
                .Include(t => t.CarVersion).ThenInclude(v => v.Model)
                .Include(t => t.Color)
                .ToListAsync();
        }
        ...
        // ✅ THÊM
        public async Task<TestDriveAppointment?> GetByIdAsync(int id)
        {
            return await _context.TestDriveAppointments
                .Include(t => t.Customer)
                .Include(t => t.CarVersion).ThenInclude(v => v.Model)
        ...
        public async Task DeleteTestDriveAppointments(ICollection<TestDriveAppointment> list)
        {
            _context.TestDriveAppointments.RemoveRange(list);
        ...
        // ✅ THÊM
        public async Task<bool> ExistsCustomerOverlapAsync(
            int customerId,
            DateTime startLocal,
            int durationMinutes = 60,
            int bufferMinutes = 0,
